...
var AMapBaseService = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_l7Core.TYPES.IGlobalConfigService), _dec3 = (0, _inversify.inject)(_l7Core.TYPES.MapConfig), _dec4 = (0, _inversify.inject)(_l7Core.TYPES.ICoordinateSystemService), _dec5 = (0, _inversify.inject)(_l7Core.TYPES.IEventEmitter), _dec(_class = (_class2 = /*#__PURE__*/function () {
  function AMapBaseService() {
    ...
    (0, _defineProperty2.default)(this, "handleCameraChanged", function (e) {
      ...
      var _this$getCenter = _this.getCenter(),
          ...
          lat = _this$getCenter.lat; // Tip: 触发地图变化事件
      ...
      if (_this.cameraChangedCallback) {
        ...
        var _this$config$offsetZo = _this.config.offsetZoom,
            offsetZoom = _this$config$offsetZo === void 0 ? LNGLAT_OFFSET_ZOOM_THRESHOLD : _this$config$offsetZo; // console.log('this.viewport', this.viewport)
  ...
  (0, _createClass2.default)(AMapBaseService, [{
    ...
    value: function getBounds() {
      ...
      var minlng = center.lng < SW.getLng() ? SW.getLng() - 180 : SW.getLng(); // 兼容 Mapbox，统一返回西南、东北
    ...
    value: function lngLatToPixel(lnglat) {
      var p = this.map.lnglatToPixel(new AMap.LngLat(lnglat[0], lnglat[1])); // lngLatToPixel
    ...
    value: function lngLatToMercator( // eslint-disable-next-line @typescript-eslint/no-unused-vars
    lnglat, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    altitude) {
      return {
        x: 0,
        y: 0,
    ...
    value: function getModelMatrix(lnglat, altitude, rotate) {
      ...
      var flat = this.viewport.projectFlat(lnglat); // @ts-ignore
                ...
                return new Promise(function (resolve) {
                  var resolveMap = function resolveMap() {
                    if (mapInstance) {
                      ...
                      var map = new AMap.Map(_this2.$mapContainer, mapConstructorOptions); // 监听地图相机事件

                      map.on('camerachange', _this2.handleCameraChanged); // Tip: 为了兼容开启 MultiPassRender 的情况
    ...
    value: function meterToCoord(center, outer) {
      ...
      var meterDis = AMap.GeometryUtil.distance((0, _construct2.default)(AMap.LngLat, (0, _toConsumableArray2.default)(center)), (0, _construct2.default)(AMap.LngLat, (0, _toConsumableArray2.default)(outer))); // Tip: 三维世界坐标距离
    ...
    value: function destroy() {
      ...
      // TODO: 销毁地图可视化层的容器
      (_this$$mapContainer = this.$mapContainer) === null || _this$$mapContainer === void 0 ? void 0 : (_this$$mapContainer$p = _this$$mapContainer.parentNode) === null || _this$$mapContainer$p === void 0 ? void 0 : _this$$mapContainer$p.removeChild(this.$mapContainer); // @ts-ignore
